...
# from blueboat_vehicle_interface.my_boat_controller import MyBoatController
# import sys
...
class VehicleInterface2(Node):
    def __init__(self):
        super().__init__('blueboat_vehicle_interface2')
        ...
        # Connecting to boat using DroneKit
        sitl = dronekit_sitl.start_default()
        vehicle = connect(self.mavlink_connection_string, wait_ready=True)
        ...
        # self.vehicle.set_boat_param("NAVL1_PERIOD", 2) # lower for aggressive turning, higher for smoother but laggy
