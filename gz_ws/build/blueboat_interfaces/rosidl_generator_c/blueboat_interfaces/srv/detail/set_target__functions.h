...
#ifndef BLUEBOAT_INTERFACES__SRV__DETAIL__SET_TARGET__FUNCTIONS_H_
#define BLUEBOAT_INTERFACES__SRV__DETAIL__SET_TARGET__FUNCTIONS_H_
...
#include "blueboat_interfaces/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_blueboat_interfaces
bool
 ...
 * calls
 * blueboat_interfaces__srv__SetTarget_Request__init().
...
/**
 * It calls
 * blueboat_interfaces__srv__SetTarget_Request__fini()
 ...
 * blueboat_interfaces__srv__SetTarget_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * blueboat_interfaces__srv__SetTarget_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * blueboat_interfaces__srv__SetTarget_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_blueboat_interfaces
...
/**
 * It calls
 * blueboat_interfaces__srv__SetTarget_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_blueboat_interfaces
...
/**
 * It allocates the memory for the array and calls
 * blueboat_interfaces__srv__SetTarget_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_blueboat_interfaces
...
/**
 * It calls
 * blueboat_interfaces__srv__SetTarget_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // BLUEBOAT_INTERFACES__SRV__DETAIL__SET_TARGET__FUNCTIONS_H_
